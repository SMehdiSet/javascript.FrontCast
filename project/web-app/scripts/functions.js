...
const creatItemDOM = item => {
    ...
    searchResultsitem.className = 'item'

    checkBox.setAttribute('type', 'checkBox')
    checkBox.checked = item.exist
    availability.appendChild(checkBox)
    ...
    availabilityText.textContent = 'موجود'
    ...
    searchResultsitem.appendChild(availability)

    itemPrice.textContent = `قیمت: ${item.price}`
    searchResultsitem.appendChild(itemPrice)
